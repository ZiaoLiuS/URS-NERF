...
class TriMipEncoding(nn.Module):
    ...
    def forward(self, x, level, step):
        ...
        # todo debug
        # if step < 10000:
        #     downsampled_tensor = torch.nn.functional.interpolate(self.fm.permute(0, 3, 1, 2), size=(128, 128),
        #                                     mode='bilinear', align_corners=False).permute(0, 2, 3, 1)
        # elif 18000 > step > 10000:
        #     downsampled_tensor = torch.nn.functional.interpolate(self.fm.permute(0, 3, 1, 2), size=(256, 256),
        #                                                          mode='bilinear', align_corners=False).permute(0, 2, 3, 1)
        # else:
        #     downsampled_tensor = self.fm
